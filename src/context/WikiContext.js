...
export const WikiProvider = ({ children }) => {
    const [pages, setPages] = useState([
        { id: 1, tags: ['homepage'], title: 'Home', subtitle: 'Subtitle', comments: ['This is an example comment!'], content: '<><Hero title="Welcome to the Wiki!" subtitle="this is a subtitle" /> <Tags /> <FirstTitle title="Contents" /> <LinkComponent title="Personal Documents" />  <LinkComponent title="Employment Agency" /> <FirstTitle title="Choose your route" /> <SecondTitle title="Do you need any help in using the wiki?" /> <LinkComponent title="Guide" /> </>', language: 'en', subPages: [2, 3] },
        ...
        { id: 1, tags: ['homepage'], title: 'Home', subtitle: 'Subtitle', comments: ['Benvenuti!'],  content: '<><Hero title="Benvenuto nella wiki!" subtitle="Questo è un sottotitolo" /> <Tags /> <FirstTitle title="Inizia a scrivere qualcosa!" /> </>', language: 'it', subPages: [2, 3] }
    ]);
