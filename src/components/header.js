...
export const Header = (props) => {
  ...
  return (
    <div className="flex flex-auto flex-col pt-3 mt-5 text-xl font-bold text-center text-black border-b border-black border-solid ">
      ...
      {openLanugage && (
        <div
          className="absolute right-0 z-10 mt-10 w-52 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
          role="menu"
              ...
              <div className="p-4 md:p-5 space-y-4">
                {pages
                  .filter(
                    (page) =>
                      page.tags.some((tag) =>
                        tag.toLowerCase().includes(valueSearch.toLowerCase())
